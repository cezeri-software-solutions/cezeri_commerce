...
class ReceiptBloc extends Bloc<ReceiptEvent, ReceiptState> {
  ...
  ReceiptBloc({
    ...
    on<CreateNewAppointmentManuallyEvent>(_onCreateNewAppointmentManually);
...
//? #########################################################################
  ...
  void _onCreateNewAppointmentManually(CreateNewAppointmentManuallyEvent event, Emitter<ReceiptState> emit) async {
