    ...
    return MyFormFieldContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(),
          _DataView(bloc: bloc, containerWidth: containerWidth, padding: padding),
        ],
      ),
    );
  }
...
class _DataView extends StatelessWidget {
  ...
  const _DataView({required this.bloc, required this.containerWidth, required this.padding});
