...
class ReceiptDetailPaymentMethodCard extends StatelessWidget {
  ...
  const ReceiptDetailPaymentMethodCard({super.key, required this.receiptBloc});
            ...
            child: Column(
              ...
              children: [
                ...
                MyDropdownButtonSmall(
                  ...
                  onChanged: (name) => receiptBloc.add(
                ...
                MyDropdownButtonSmall(
                  ...
                  onChanged: (name) => receiptBloc.add(OnAppointmentPaymentStatusChangedEvent(paymentStatus: name!)),
