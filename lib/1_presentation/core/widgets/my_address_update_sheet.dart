...
import 'my_modal_scrollable.dart';
  ...
  Widget build(BuildContext context) {
    return MyModalScrollable(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: MyTextFormFieldSmall(labelText: 'PLZ', controller: _postcodeNameController)),
            Gaps.w8,
            Expanded(child: MyTextFormFieldSmall(labelText: 'Stadt', controller: _cityNameController)),
          ],
        ),
        Gaps.h16,
        if (!widget.comeFromSupplier) ...[
