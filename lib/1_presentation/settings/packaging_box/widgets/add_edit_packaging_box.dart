      ...
      child: Form(
        child: Column(
          ...
          children: [
            ...
            Gaps.h8,
            MyTextFormFieldSmall(
              fieldTitle: 'EK-Preis Netto',
              controller: _wholesalePriceController,
              keyboardType: const TextInputType.numberWithOptions(decimal: true),
            ),
            Gaps.h8,
            MyTextFormFieldSmall(
              fieldTitle: 'Lagerbestand',
