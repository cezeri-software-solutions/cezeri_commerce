...
MainSettings _$MainSettingsFromJson(Map<String, dynamic> json) => MainSettings(
      ...
      incomingInvoicePraefix: json['incomingInvoicePraefix'] as String,
      ...
      nextIncomingInvoiceNumber:
          (json['nextIncomingInvoiceNumber'] as num).toInt(),
...
Map<String, dynamic> _$MainSettingsToJson(MainSettings instance) =>
    <String, dynamic>{
      ...
      'incomingInvoicePraefix': instance.incomingInvoicePraefix,
      ...
      'nextIncomingInvoiceNumber': instance.nextIncomingInvoiceNumber,
