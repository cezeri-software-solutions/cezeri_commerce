...
class Reorder {
  ...
  Reorder({
    ...
    // required this.productsTotalNet,
    // required this.productsTotalGross,
    // required this.productsTotalTax,
    required this.shippingPriceNet,
    // required this.shippingPriceGross,
    // required this.shippingPriceTax,
    required this.additionalAmountNet,
    // required this.additioanlAmountGross,
    // required this.additioanlAmountTax,
    // required this.discountTotalNet,
    // required this.discountTotalGross,
    // required this.discountTotalTax,
    required this.discountAmountNet,
    // required this.discountAmountGross,
    // required this.discountAmountTax,
